...
class EmployeeController {
  ...
  async create(req, res, next) {
    try {
      ...
      console.log(error);
      return next(
        new ApiError(500, "An error occurred while creating an employee")
      );
    }
  }
  ...
  async update(req, res, next) {
    try {
      ...
      console.log(error);
      return next(
        new ApiError(500, "An error occurred while updating a employee")
      );
    }
  }
  ...
  async findOne(req, res, next) {
    try {
      ...
      console.log(error);
      return next(
        new ApiError(500, "An error occurred while retrieving a employee")
      );
    }
  }
  ...
  async delete(req, res, next) {
    try {
      ...
      console.log(error);
      return next(
        new ApiError(500, "An error occurred while deleting a employee")
      );
    }
  }
  ...
  async deleteAll(req, res, next) {
    try {
      ...
      console.log(error);
      return next(
        new ApiError(500, "An error occurred while deleting employees")
      );
    }
  }
} 
